...
<body style="font-family: 'Cormorant Garamond';font-family: Poppins,sans-serif;
  font-weight: 300;
  font-display: swap;src: url(https://fonts.gstatic.com/s/cormorantgaramond/v10/co3WmX5slCNuHLi8bLeY9MK7whWMhyjYrEPjuz-HzhO7_w.woff2) format('woff2');
...
<div  style="padding-left:650px;padding-top:50px;"></div>
<a   style="color:black;font-size:20px;" href="http://localhost/hev/ecommerce/index.html">Home </a> &nbsp; &nbsp; 
<p style="color:black;font-size:20px;">/</p>
<a   style="color:black;font-size:20px;" href="">&nbsp;Clothing</a> 
...
<div class="row">
  <div class="col-3">
   ...
   <div class="card" style="width: 500px;margin-left:100px;margin-bottom:100px;padding-left:10px;">

<div class="card-body">
  
<h1 style="padding-left:20px;font-weight:bold;">
...
<h2 style="font-weight:bold;padding-left:20px;">
<br>
...
<button type="button" class="btn btn-light" style="border-radius:30%;border: 1px solid black;">Bag</button>
<button type="button" class="btn btn-light" style="border-radius:30%;border: 1px solid black;">Fashion</button>
<button type="button" class="btn btn-light" style="border-radius:30%;border: 1px solid black;">Jumper</button>
<button type="button" class="btn btn-light" style="border-radius:30%;border: 1px solid black;">Wisher</button>
</div>
